...
<head>
    ...
    <link href="/static/manage/styles.css" rel="stylesheet">
    </head>
<body>
    <script src="/static/manage/navigation.js"></script>
    
    <div class="main-container text-center">
        <h1 class="title-gradient"><img src="/static/icon.png" alt="ImageAIServer Icon" class="icon-inline"> ImageAIServer</h1>
        ...
        <div class="api-endpoints">
            <div class="endpoint"><strong>POST</strong> /v1/chat/completions <span class="text-muted">• Vision + text inference (ONNX)</span></div>
            <div class="endpoint"><strong>POST</strong> /chat-server/v1/chat/completions/torch <span class="text-muted">• PyTorch models (optional)</span></div>
            <div class="endpoint"><strong>POST</strong> /v1/image/compare_faces <span class="text-muted">• Face comparison</span></div>
            <div class="endpoint"><strong>GET</strong> /v1/backends <span class="text-muted">• Backend availability status</span></div>
            <div class="endpoint"><strong>GET</strong> /v1/models <span class="text-muted">• List available models</span></div>
            <div class="endpoint"><strong>GET</strong> /health <span class="text-muted">• Server health check</span></div>
        </div>
    </div>
</body>
</html>

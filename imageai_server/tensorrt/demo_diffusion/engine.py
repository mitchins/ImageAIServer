...
# Set environment variable for TensorRT-RTX before any imports
...
class Engine:
    ...
    def activate(self, device_memory=None):
        if device_memory:
            # Handle TensorRT-RTX API difference: create_execution_context_without_device_memory vs create_execution_context
            if hasattr(self.engine, 'create_execution_context_without_device_memory'):

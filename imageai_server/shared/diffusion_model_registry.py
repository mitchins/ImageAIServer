...
class DiffusionModelRegistry:
    ...
    def _load_builtin_models(self):
        ...
        sd15_onnx_fp32 = WorkingSet(
            name="onnx_fp32",
            components={
                Component.UNET: ComponentSpec("imgailab/sd15-onnx-cpu", filename="unet/model.onnx", quantization=Quantization.FP32, backend=Backend.ONNX),
                Component.VAE: ComponentSpec("imgailab/sd15-onnx-cpu", filename="vae_decoder/model.onnx", quantization=Quantization.FP32, backend=Backend.ONNX),
                Component.TEXT_ENCODER: ComponentSpec("imgailab/sd15-onnx-cpu", filename="text_encoder/model.onnx", quantization=Quantization.FP32, backend=Backend.ONNX),
                Component.SCHEDULER: ComponentSpec("imgailab/sd15-onnx-cpu", subfolder="scheduler", backend=Backend.ONNX),
                Component.TOKENIZER: ComponentSpec("imgailab/sd15-onnx-cpu", subfolder="tokenizer", backend=Backend.ONNX),
            },
            optimal_settings={
                "num_inference_steps": 20,
                "guidance_scale": 7.5,
            ...
            description="ONNX FP32 CPU - Best quality, CPU compatible"
        )
        ...
        self.models["sd15"] = ModelDefinition(
            ...
            architecture="sd15",
            working_sets=[sd15_pytorch_fp16, sd15_onnx_fp32],
            default_working_set="onnx_fp32",  # ONNX FP32 as default for CPU compatibility
